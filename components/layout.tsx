        ...
        <div className="flex flex-col min-h-screen"> {/* turn "body" into vertical flex container with .flex/.flex-col */}
            ...
            <header className="sm:pt-5 bg-gray-600 dark:bg-gray-800 overflow-hidden">
                <div className="container mx-auto flex w-full justify-between items-center px-5 ">
                    <h1 className="text-white font-light text-2xl sm:text-4xl py-3 sm:py-2 dark:text-gray-200">
                        <Link href="/"><a className="hover:no-underline">
                            <span className={s.nguyen}>
                                <span className={s.span}>alex nguyen</span>
                            </span>
                        </a></Link>
                    </h1>
            ...
            <motion.main {...FramerConfig} className="container mx-auto flex-auto my-10 sm:my-20 px-5 dark:text-gray-200">{children}</motion.main> {/* flex-auto expands main to fill available space. */}

            <footer className="text-center dark:bg-gray-800 py-4 dark:text-gray-200">
